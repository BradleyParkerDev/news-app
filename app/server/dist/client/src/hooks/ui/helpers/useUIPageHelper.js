...
import { loadCurrentPageState, toggleCurrentIsLoading, } from '../../../../../shared/redux/slices/ui/uiSlice.js';
    ...
    useEffect(() => {
        ...
        const getPageData = async () => {
            ...
            try {
                ...
                const pageContent = await clientApiServices.ui.fetchCurrentpageState(apiPath);
                if (!isMounted)
                    return;
                console.log(pageContent);
                dispatch(loadCurrentPageState({
                    currentPage: {
                        path: routePath,
                        content: pageContent,
                        isLoading: false,
