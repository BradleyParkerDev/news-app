...
const GeneralPage = () => {
	...
	useEffect(() => {
		document.title = `General | ${ui.appName}`;
	}, [ui.appName]);

	return (
		<div id="general-page" className="flex w-full flex-col gap-6 p-4">
			<div className="w-full">
				<h1 className="font-primary text-2xl font-bold">General</h1>
			</div>
					...
					<PaginationContent>
						<PaginationItem>
							<PaginationPrevious
								...
								onClick={() => {
									ui.navigateTo(
										`/general?page=${Math.max(1, page - 1)}&limit=25`,
									);
								}}
							/>
						</PaginationItem>
						<PaginationItem>
							<PaginationLink
								...
								onClick={() => {
									ui.navigateTo(
										`/general?page=${firstPage}&limit=25`,
									);
								}}
							>
								{firstPage}
						...
						middlePage !== lastPage ? (
							<PaginationItem>
								<PaginationLink
									...
									onClick={() => {
										ui.navigateTo(
											`/general?page=${middlePage}&limit=25`,
										);
									}}
								>
									{middlePage}
						...
						{lastPage > 1 ? (
							<PaginationItem>
								<PaginationLink
									...
									onClick={() => {
										ui.navigateTo(
											`/general?page=${lastPage}&limit=25`,
										);
									}}
								>
									{lastPage}
						...
						<PaginationItem>
							<PaginationNext
								...
								onClick={() => {
									ui.navigateTo(
										`/general?page=${Math.min(lastPage, page + 1)}&limit=25`,
									);
								}}
							/>
						</PaginationItem>
