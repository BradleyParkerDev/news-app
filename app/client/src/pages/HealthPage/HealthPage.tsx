...
const HealthPage = () => {
	...
	useEffect(() => {
		document.title = `Health | ${ui.appName}`;
	}, [ui.appName]);

	return (
		<div id="health-page" className="flex w-full flex-col gap-6 p-4">
			<div className="w-full">
				<h1 className="font-primary text-2xl font-bold">Health</h1>
			</div>
					...
					<PaginationContent>
						<PaginationItem>
							<PaginationPrevious
								...
								onClick={() => {
									ui.navigateTo(
										`/health?page=${Math.max(1, page - 1)}&limit=25`,
									);
								}}
							/>
						</PaginationItem>
						<PaginationItem>
							<PaginationLink
								...
								onClick={() => {
									ui.navigateTo(
										`/health?page=${firstPage}&limit=25`,
									);
								}}
							>
								{firstPage}
						...
						middlePage !== lastPage ? (
							<PaginationItem>
								<PaginationLink
									...
									onClick={() => {
										ui.navigateTo(
											`/health?page=${middlePage}&limit=25`,
										);
									}}
								>
									{middlePage}
						...
						<PaginationItem>
							<PaginationNext
								...
								onClick={() => {
									ui.navigateTo(
										`/health?page=${Math.min(lastPage, page + 1)}&limit=25`,
									);
								}}
							/>
						</PaginationItem>
