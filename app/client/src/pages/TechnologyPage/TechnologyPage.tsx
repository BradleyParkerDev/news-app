...
const TechnologyPage = () => {
	...
	useEffect(() => {
		document.title = `Technology | ${ui.appName}`;
	}, [ui.appName]);

	return (
		<div id="technology-page" className="flex w-full flex-col gap-6 p-4">
			<div className="w-full">
				<h1 className="font-primary text-2xl font-bold">Technology</h1>
			</div>
					...
					<PaginationContent>
						<PaginationItem>
							<PaginationPrevious
								...
								onClick={() => {
									ui.navigateTo(
										`/technology?page=${Math.max(1, page - 1)}&limit=25`,
									);
								}}
							/>
						</PaginationItem>
						<PaginationItem>
							<PaginationLink
								...
								onClick={() => {
									ui.navigateTo(
										`/technology?page=${firstPage}&limit=25`,
									);
								}}
							>
								{firstPage}
						...
						middlePage !== lastPage ? (
							<PaginationItem>
								<PaginationLink
									...
									onClick={() => {
										ui.navigateTo(
											`/technology?page=${middlePage}&limit=25`,
										);
									}}
								>
									{middlePage}
						...
						{lastPage > 1 ? (
							<PaginationItem>
								<PaginationLink
									...
									onClick={() => {
										ui.navigateTo(
											`/technology?page=${lastPage}&limit=25`,
										);
									}}
								>
									{lastPage}
						...
						<PaginationItem>
							<PaginationNext
								...
								onClick={() => {
									ui.navigateTo(
										`/technology?page=${Math.min(lastPage, page + 1)}&limit=25`,
									);
								}}
							/>
						</PaginationItem>
