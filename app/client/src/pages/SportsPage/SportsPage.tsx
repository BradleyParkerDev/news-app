...
const SportsPage = () => {
	...
	useEffect(() => {
		document.title = `Sports | ${ui.appName}`;
	}, [ui.appName]);

	return (
		<div id="sports-page" className="flex w-full flex-col gap-6 p-4">
			<div className="w-full">
				<h1 className="font-primary text-2xl font-bold">Sports</h1>
			</div>
					...
					<PaginationContent>
						<PaginationItem>
							<PaginationPrevious
								...
								onClick={() => {
									ui.navigateTo(
										`/sports?page=${Math.max(1, page - 1)}&limit=25`,
									);
								}}
							/>
						</PaginationItem>
						<PaginationItem>
							<PaginationLink
								...
								onClick={() => {
									ui.navigateTo(
										`/sports?page=${firstPage}&limit=25`,
									);
								}}
							>
								{firstPage}
						...
						middlePage !== lastPage ? (
							<PaginationItem>
								<PaginationLink
									...
									onClick={() => {
										ui.navigateTo(
											`/sports?page=${middlePage}&limit=25`,
										);
									}}
								>
									{middlePage}
						...
						<PaginationItem>
							<PaginationNext
								...
								onClick={() => {
									ui.navigateTo(
										`/sports?page=${Math.min(lastPage, page + 1)}&limit=25`,
									);
								}}
							/>
						</PaginationItem>
